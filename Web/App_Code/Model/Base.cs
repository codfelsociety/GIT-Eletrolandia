...
public class Base
{
    ...
    public class Consulta
    {
        ...
        /// <summary>
        /// Recebe o nome da tabela da sequência e retorna seu próximo valor em Int32
        /// </summary>
        public static int NextID(string seq)
        {
            string SQL = "SELECT SEQ_" + seq + ".NEXTVAL FROM DUAL";
            return Convert.ToInt32(DataTable(SQL).Rows[0][0]);
        }
    }
}